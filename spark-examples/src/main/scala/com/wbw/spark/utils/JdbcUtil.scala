...
object JdbcUtil {
  ...
  def init(): DataSource = {
    ...
    properties.setProperty("url", "jdbc:mysql://server101:3306/spark2022")
    properties.setProperty("username", "ambari")
    properties.setProperty("password", "ambari123")
  ...
  def main(args: Array[String]): Unit = {
    println(executeUpdate(getConnection, "show databases;", null))
  }
